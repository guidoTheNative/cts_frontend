        ...
        <ul class="nav nav-tabs flex flex-col md:flex-row flex-wrap pl-0 mb-4 border-b border-blue-300" id="tabs-menu"
          ...
          <li class="nav-item mr-1" role="presentation">
            <a href="#user-settings"
              ...
              aria-controls="user-settings" aria-selected="false">Commodity Type</a>
          </li>
...
import UserSettings from "../../../components/pages/commoditytypes/settings.component.vue";
//SCHEMA//AND//STORES
...
const updateUser = async (newValues) => {
  ...
  CommodityTypeStore
    ...
    .catch((error) => {
      Swal.fire({
        title: "Failed",
        text: "failed to update commodity type (" + error + ")",
        icon: "error",
        confirmButtonText: "Ok",
      });
    })
