      ...
      <div class="md:grid md:grid-cols-3 md:gap-6">
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
          ...
          <div class="px-4 text-right sm:px-6 pt-2">
            <button v-show="!open" @click="open = true" type="button"
...
const handleFileUpload = (e) => {
  ...
  if (file.type.startsWith('image/') && file.size > 1000000) {
    ...
    alert('Please select an image with a maximum size of 1MB.');
  ...
  if (file.type.startsWith('video/') && file.size > 5000000) {
    ...
    alert('Please select a video with a maximum size of 5MB.');
    event.target.value = ''; // Clear the input
    return;
  }
