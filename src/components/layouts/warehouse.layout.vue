    ...
    <nav aria-label="Sidebar" class="shadow-xl px-1 py-3 rounded-md" style="background-color: #096eb4;">
      <div class="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div class="flex items-center justify-between">
          ...
          <span class="font-bold text-white mx-4">DODMA CTS | District Officer
        ...
        <div class="flex space-x-4">
          <!-- Display the first five items excluding dropdownItems -->
          ...
          <!-- Dropdown for Warehouse Management and Reports -->
          <div class="relative">
