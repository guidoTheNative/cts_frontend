...
import { CubeIcon, ViewListIcon, ArchiveIcon, TruckIcon, InboxIcon, ClipboardCheckIcon, GiftIcon, ClipboardListIcon,  } from "@heroicons/vue/outline";
...
const options = ref([
  { label: 'Requisitions', icon:  ClipboardListIcon, path: '/requisitions' },
  ]);
</script>
