<template>
  <div>
    <button type="button"
      class="font-body inline-block px-6 py-2.5 bg-gray-500 text-white font-medium text-xs leading-tight rounded shadow-md hover:bg-gray-600 hover:shadow-lg focus:bg-gray-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-100 ease-in-out capitalize"
      @click="open = true">
      new user
    </button>
                  ...
                  <div class="grid grid-cols-6 gap-2">
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <input type="text" name="first-name" id="first-name" v-model="firstName" autocomplete="given-name"
                        class="mt-1 focus:ring-gray-300 focus:border-gray-300 block w-full shadow-sm sm:text-sm border-2 border-gray-300 rounded-md" />
                      <p class="text-red-500 text-xs italic pt-1">
                        {{ firstNameError }}
                      </p>
                    </div>
                  ...
                  <div class="grid grid-cols-6 gap-6 mt-3">
                    <div class="col-span-6 sm:col-span-4">
                      <label for="password" class="block text-sm font-medium text-gray-700">
                        Password</label>
                      <input id="password" name="password" :type="isPwd ? 'password' : 'text'" v-model="password"
                        autocomplete="off"
                        class="mt-1 focus:ring-gray-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-blue-500 rounded-md" />
