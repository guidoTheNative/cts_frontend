<template>
  <div>
    <button
      type="button"
      class="font-body inline-block px-6 py-2.5 bg-gray-500 text-white font-medium text-xs leading-tight rounded shadow-md hover:bg-gray-600 hover:shadow-lg focus:bg-gray-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-800 active:shadow-lg transition duration-100 ease-in-out capitalize"
      @click="open = true"
    >
      new user
    </button>
          ...
          >
            ...
            >
              ...
              <form
                ...
                v-if="roleId == 'ADMIN1' || roleId == 'USER1'"
              >
                    ...
                    <div class="col-span-6 sm:col-span-4">
                      ...
                      <div class="flex items-center w-full">
                        <input
                          ...
                          v-model="isPwd"
                          type="checkbox"
                          class="ml-2 h-4 w-4 border-gray-300 text-teal-600 focus:ring-teal-600 rounded"
                        />
                        <label
                          for="hide-password"
