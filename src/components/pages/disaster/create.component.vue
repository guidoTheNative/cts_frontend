                  ...
                  <div class="grid grid-cols-6 gap-2">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <select id="type" name="type" v-model="type" autocomplete="type-name"
                        class="mt-1 focus:ring-gray-500 focus:border-blue-300 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        <option v-for="item in ['Floods', 'Heavy Rains']" :key="item" :value="item" class="uppercase">
                          {{ item }}
                        </option>
                      </select>
                      <p class="text-red-500 text-xs italic pt-1">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <select id="district" name="district" v-model="district" autocomplete="district-name"
                        class="mt-1 focus:ring-gray-500 focus:border-blue-300 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        <option v-for="district in ['Nsanje', 'Chikwawa', 'Phalombe']" :key="district" :value="district"
                          class="uppercase">
                          {{ district }}
                        </option>
                      </select>
