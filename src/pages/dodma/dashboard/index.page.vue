                  ...
                  <div>
                    ...
                    <div v-if="stat.moreInfo" class="text-sm text-gray-500 mt-4">
                      <router-link v-if="stat.label == 'Total Required Tonnage (Emergency Response)'"
                        to="/dodma/required-leanseason" class="text-blue-500 hover:underline">
                        View Details
                      </router-link>
                      <router-link v-if="stat.label == 'Total Stocks Planned (Lean Season Response)'"
                        to="/dodma/loadingplans" class="text-blue-500 hover:underline">
                        View Details
                      </router-link>
                      <router-link v-if="stat.label == 'Requisitions Pending (Emergency Response)'"
                        to="/dodma/requisition-management" class="text-blue-500 hover:underline">
                        View Details
                      </router-link>
                    </div>
                  </div>
...
const stats2 = ref([
  ...
  {
    label: 'Requisitions Pending (Emergency Response)',
