    ...
    <nav aria-label="Sidebar" class="shadow-xl px-1 py-3 rounded-md" style="background-color: #096eb4;">
      <div class="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div class="flex items-center justify-between">
          ...
          <span class="font-bold text-white mx-4">DODMA CTS | Recipient
...
function gotoSystemsettings() {
  $router.push({ path: '/recipient/system' });
...
function navigation() {
  let navList = [
    { name: "Home", href: "/recipient/dashboard", icon: HomeIcon, current: false },
