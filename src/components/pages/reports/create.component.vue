<template>
  <div>
    <button
      type="button"
      style="background-color: #0a6eb4;"
      class="font-body inline-block px-6 py-2.5 text-white font-medium text-xs leading-tight rounded shadow-md hover:bg-gray-600 hover:shadow-lg focus:bg-gray-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-teal-500 active:shadow-lg transition duration-100 ease-in-out capitalize"
      @click="open = true"
    >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <h5
                  class="font-body text-md font-medium leading-normal text-gray-800"
                  id="formModalLabel"
                >
                  Generate Report
                </h5>
